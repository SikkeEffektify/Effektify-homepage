...
import bg from '../assets/seo-sokmotoroptimering-varberg.webp'
...
export default function SEOVarberg() {
  return (
    <>
    <section>
   <div className='hero '>
    ...
    <div class="vidContent2 hero-image-text pb-40  bg-black/60">
        <h1 class='text-6xl pl-4 text-left uppercase text-white pb-10'>Seo Varberg<span class="text-rose-300">.</span></h1>
