...
export default function GoogleAdsEN() {
  return (
    ...
    <Hero 
      title={"Get more visitors through advertising on google adds"}
      videoLink={videoBg}
    />
  ...
  <div class="relative h-32 w-32 ...">
    ...
    <Heading 
      ...
      do you want to adveritse on Facebook instead?
      <br />
    ...
    <Heading 
      bg={"fb-custom-color"}
      textColor={"text-white"}
      title={"How to choose the right keywords when advertising with Google Ads?"}
      descCustomHtml={`
