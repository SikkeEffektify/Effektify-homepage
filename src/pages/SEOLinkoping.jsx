  ...
  return (
   ...
   <div className='hero '>
    ...
    <div class="vidContent2 hero-image-text pb-40  bg-black/60">
        <h1 class='text-5xl pl-4 text-left uppercase text-white pt-5 pb-10'>Seo Linköping<span class="text-rose-300">.</span></h1>
