...
export default function Webbcopy() {
  return (
    <>
   ...
   <div class='pt-20 heading-container bg-white text-black'>
    ...
    Webbcopy innehåller många delar   
    </h1>
    ...
    <h1 class="text-left text-3xl pb-5 ">
    Varför det är viktigt att arbeta med webbcopy på din hemsida
    </h1>
    <p class="text-sm text-left pb-5">
    ...
    <h1 class="text-left text-2xl pb-10 ">
    Webbcopy förklarar för sökmotorn och besökaren vad sidan handlar om
    </h1>

    <h1 class="text-left text-4xl pb-10 ">
    Content
    <br />
    och innehåll   
    </h1>
    ...
    Hur du skriver texter som
    gör att din hemsida syns online
    </h1>
    <p class="text-sm text-left pb-5">
    ...
    <img class="mx-auto pt-5 drop-shadow-lg pb-10" src={sidandstitel} alt="" />

    <h1 class="text-left text-3xl pb-10 ">
    Ha med sökordet i huvudrubriken
    </h1>
    <p class="text-sm text-left pb-5">
    En annan viktigt signal till Google om vad sidan handlar om är huvudrubiken. På samma sätt som huvudrubriken i en tidningsartikel ska förklara vad artikeln handlar om behöver huvudrubriken förklara sidans innehåll. Detta är viktig information både för Google och för dina besökare.  
    </p>
    </div>
    </section>
    ...
    <div class='pt-20 heading-container bg-white text-black'>
        <h1 class="text-left text-3xl pb-5 ">
        Kontrollera search intent så att din text matchar det Google förväntar sig att den ska innehålla
        </h1>
        <p class="text-sm text-left pb-5">
        När du skapar undersidor är det viktigt att de fokuserar på ett specifikt ämne. Det är inte ovanligt att se hemsidor där en undersida heter “våra tjänster” och innehållet på den sidan handlar om många olika saker/tjänster.    
        </p>
