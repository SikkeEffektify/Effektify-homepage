...
export default function Footer() {
  return (
    <>
    <div >
    <div class="bg-black footer-container md:grid md:grid-cols-3  text-white text-center">
        ...
        <section>
            <div class="md:pt-20   pb-10 footer-list">
            ...
            <section>
            <div class="text-center pb-10 md:pt-20    footer-list">
            ...
            <h3  class="text-center text-lg col-span- uppercase pt-5 font-black">Starta om <br /> rundturen</h3>
            <div class="md:hidden">
            <p class="text-xs copyright pt-20">©2023 Effektify. All rights reserved</p>
            <div class="footer-logo pt-10 pb-10">
                <a href="/"><img class=" mx-auto " src={logo} alt="" /></a>
