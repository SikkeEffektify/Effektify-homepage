...
export const HeadingCareerEN = () => {
  return (
    <>
    <div class='pt-20 heading-container text-left text-black bg-white'>
    <h1 class="text-3xl uppercase text-rose-300 pb-5">
      <span class="text-black">Vacant positions</span>.
    </h1>
    <p class="tracking-widest text-sm pb-5">Do you feel that you would have enjoyed our workplace as much as we do? Do you feel that you could contribute and develop with us? At Effektify, we’re always on the lookout for creative and adventurous talents who see themselves working on exciting projects with the best colleagues in the world.</p>
    <p class="tracking-widest text-sm pb-5">If you feel that any of the positions below would be perfect for you, send us an application right away!</p>
    </div>
