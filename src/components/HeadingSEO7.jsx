...
export const HeadingSEO7 = () => {
  return (
    <>
    <div class='pt-20 heading-container text-center text-black bg-white'>
    <h1 class="text-3xl uppercase pb-5">Vad är Google Analytics?</h1>
    ...
    <section class="bg-white">
     ...
     <div class="custom-back max-w-sm p-6 pb-10  shadow headingSEO-card4 pt-10">
    ...
    <div class='pt-20 heading-container text-center text-black bg-white'>
    <h1 class="text-3xl uppercase pb-5">Hur fungerar Google Analytics?</h1>
    <p class="text-sm text-left pb-5">
    ...
    <div class="pt-5 cards-container p-6">
     <div class="custom-back max-w-sm p-6 pb-10  shadow headingSEO-card4 pt-10">
        <h1 class="text-center text-xl pt-5 pb-5 text-white">VARFÖR SKA MAN VÄLJA GOOGLE ANALYTICS?</h1>
        <p class="text-sm text-white pb-5">
    ...
    <section class="bg-white">
    <div class="pt-5 cards-container p-6">
     <div class="custom-back max-w-sm p-6 pb-10  shadow headingSEO-card5 pt-10">
        <h1 class="text-center text-xl pt-5 pb-5 text-white">Hur kommer du igång med GSC?</h1>
        <p class="text-sm text-white pb-5">
